...
program
  ...
  .option('-s,--stdout', 'output result to stdout instead of file')
  ...
  .option('--only <exts>', 'only include extensions, e.g. .mjs,.ts,.js')
  .option('--no-only', 'disable extension filtering')
